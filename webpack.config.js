...
var bourbonArray = require("bourbon").includePaths;
var neatArray = require("bourbon-neat").includePaths;
bourbonArray.push(neatArray[0]);
...
module.exports = {
  ...
  entry: {
    ...
    'components': [
      './src/app/components/base/base_modules',
      './src/app/components/patterns/patterns_modules',
      './src/app/components/shared/shared_modules'
    ],
    'plugins': [
  ...
  module: {
    loaders: [
      ...
      {test: /\.scss$/, loaders: ["raw","sass?sourceMap"], include: [
        path.resolve(__dirname, "src/app"),
      ] },
      
      { test: /\.scss$/, loaders: ["style","css?sourceMap", "sass?sourceMap"], include: [
